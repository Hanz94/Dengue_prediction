...
{
  sj_train_set$station_min_temp_c=lag(sj_train_set$station_min_temp_c, 8)
  ...
  sj_train_set$reanalysis_min_air_temp_k=lag(sj_train_set$reanalysis_min_air_temp_k, 7)
  features = c("reanalysis_specific_humidity_g_per_kg",
               "reanalysis_dew_point_temp_k",
               "station_avg_temp_c",
               "station_min_temp_c",
...
write.csv(predictions, 'G:/S7/Data Mining/Dengue/Submissions/predictions_with_lags_2.csv', row.names = FALSE)
