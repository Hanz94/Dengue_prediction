...
preprocessData <- function(data_path, labels_path = NULL)
{
  ...
  features = c("reanalysis_specific_humidity_g_per_kg", "reanalysis_dew_point_temp_k",
               "station_avg_temp_c", "station_min_temp_c","reanalysis_max_air_temp_k")
...
write.csv(predictions, 'G:/S7/Data Mining/Dengue/Submissions/predictions_zero.csv', row.names = FALSE)
