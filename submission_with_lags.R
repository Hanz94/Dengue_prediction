...
{
  sj_train_set$reanalysis_specific_humidity_g_per_kg=lag(sj_train_set$reanalysis_specific_humidity_g_per_kg, 7)
  sj_train_set$reanalysis_dew_point_temp_k=lag(sj_train_set$reanalysis_dew_point_temp_k, 7) 
  sj_train_set$station_avg_temp_c=lag(sj_train_set$station_avg_temp_c, 8) 
  sj_train_set$reanalysis_max_air_temp_k=lag(sj_train_set$reanalysis_max_air_temp_k, 6)
  features = c("reanalysis_specific_humidity_g_per_kg",
               "reanalysis_dew_point_temp_k",
               "station_avg_temp_c",
               "station_min_temp_c",
...
{
  iq_train_set$reanalysis_specific_humidity_g_per_kg=lag(iq_train_set$reanalysis_specific_humidity_g_per_kg, 2)
  iq_train_set$reanalysis_dew_point_temp_k=lag(iq_train_set$reanalysis_dew_point_temp_k, 2) 
  iq_train_set$reanalysis_min_air_temp_k=lag(iq_train_set$reanalysis_min_air_temp_k, 5) 
  iq_train_set$station_avg_temp_c=lag(iq_train_set$station_avg_temp_c, 4)
  features = c("reanalysis_specific_humidity_g_per_kg",
               "reanalysis_dew_point_temp_k",
               "station_avg_temp_c",
               "station_min_temp_c",
...
write.csv(predictions, 'G:/S7/Data Mining/Dengue/Submissions/predictions_with_lags.csv', row.names = FALSE)
